...
export function publicError(error: unknown) {
  ...
  const messages: Record<string, string> = {
    ...
    INBOX_NOT_FOUND: "対象のInboxが見つかりません。再読み込みしてください。",
    INBOX_ROUTE_INVALID: "振り分けの入力内容が正しくありません。内容を確認してください。",
    INBOX_ROUTE_IDEMPOTENCY_CONFLICT: "同じ処理IDで別の内容の振り分けが記録されています。再読み込みしてからやり直してください。",
    ...
    HABIT_NOT_ACTIVE: "休止中またはアーカイブ済みのHabitには記録できません。",
    HABIT_NOT_DUE: "このHabitは今日の対象ではありません。",
    HABIT_WEEK_ALREADY_COMPLETED: "このHabitは今週すでに実施済みです。",
    FOCUS_UPDATE_CONFLICT: "このFocusは別の画面で更新されています。再読み込みしてからやり直してください。",
    ...
    FOCUS_LIMIT_REACHED: "表示できるFocusは5件までです。先に1件を表示解除してください。",
    ...
    GOOGLE_CALENDAR_EVENT_MISSING: "Google Calendarの予定が見つかりません。再読み込みして確認してください。",
    GOOGLE_CALENDAR_EVENT_CONFLICT: "Google Calendar側で予定が変更されています。再読み込みしてから日程を決め直してください。",
    SCHEDULED_ACTION_UPDATE_CONFLICT: "このToDoは別の画面で更新されています。再読み込みしてからやり直してください。",
    SCHEDULED_ACTION_CALENDAR_MISSING: "このToDoに紐づくGoogle Calendar予定が見つかりません。",
    SCHEDULED_ACTION_CALENDAR_EXISTS: "Google Calendar予定は存在しています。再読み込みしてから日程を変更してください。",
